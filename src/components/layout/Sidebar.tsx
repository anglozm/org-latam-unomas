...
export default function Sidebar() {
    ...
    return (
        <aside className='hidden md:block w-64 h-screen fixed top-0 left-0 p-6 shadow-sm border-r transition-colors duration-500 bg-[var(--color-surface)] border-[var(--color-border)] text-[var(--color-fg)]'>
